...
void NDKHelper::HandleMessage(json_t *methodName, json_t* methodParams)
{
    ...
    #include <jni.h>
    #define  LOG_TAG    "Mahjong-for-cocos2dx"

    #define CLASS_NAME "org/cocos2dx/classes/AndroidNDKHelper"
#endif
...
extern "C"
{
    ...
    void Java_org_cocos2dx_classes_AndroidNDKHelper_CPPNativeCallHandler(JNIEnv* env, jobject thiz, jstring json)
    {
